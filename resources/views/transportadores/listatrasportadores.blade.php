    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="page-title-box">
                <h4 class="page-title">Transportadores</h4>
                <ol class="breadcrumb p-0 m-0">
                    <li>
                        <a href="#">GeoGextion</a>
                    </li>
                    <li class="active">
                        <a href="#">Trnasportadores</a>
                    </li>
                </ol>
    ...
    <script>
        ...
        $(function () {
            table = $('#table-asesores').DataTable({
                ...
                buttons: [
                    {
                        text: 'Agregar trasportador',
                        action: function (e, dt, node, config) {
                            modalBsContent.load('{{route('transportadores.crear')}}', function (response, status, xhr) {
                                switch (status) {
                                    case "success":
