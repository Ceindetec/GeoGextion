    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="page-title-box">
                <h4 class="page-title">Supervisores de Transporte</h4>
                <ol class="breadcrumb p-0 m-0">
                    <li>
                        <a href="#">GeoGextion</a>
                    </li>
                    <li class="active">
                        <a href="#">Supervisores Transporte</a>
                    </li>
                </ol>
    ...
    <script>
        ...
        $(function () {
            table = $('#table-asesores').DataTable({
                ...
                ajax: {
                    url: "{!!route('gridasupervisorestrasporte')!!}",
                    "type": "get"
                },
                columns: [
                ...
                buttons: [
                    {
                        ...
                        action: function (e, dt, node, config) {
                            modalBsContent.load('{{route('supervisortransporte.crear')}}', function (response, status, xhr) {
                                switch (status) {
                                    case "success":
